...
import { LineChart, Sparkles, Clock, ArrowRight, CheckCircle2 } from "lucide-react";
      ...
      <Card className="bg-card/95 border border-border/60 rounded-2xl shadow-2xl max-w-lg w-full">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-heading font-bold text-foreground mb-1">
            Dominando o Variável
          </h2>
          <p className="text-sm text-muted-foreground mb-6">
            ETFs, Ações e Fundos Imobiliários
          </p>
...
export default DominandoVariavel;
