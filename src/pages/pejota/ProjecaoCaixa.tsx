...
export default function ProjecaoCaixa() {
  return (
    <PejotaModuleShell
      ...
      reuse="Transplante do Zephyr (planned_events → business_planned_events). Passa a alimentar o CashFlowSimulator do Atlas (substitui a premissa fixa 'caixa = lucro × 3')."
      status="planejado"
      icon={CalendarRange}
    />
  );
