...
import { HeartHandshake, Sparkles, Clock, ArrowRight, CheckCircle2 } from "lucide-react";
...
const BENEFITS = [
  ...
  "Modelos de divisão: junto, separado ou híbrido",
  "O orçamento do casal na prática",
  "Metas juntos: como priorizar quando cada um quer coisas diferentes",
  "Investindo a dois: perfis de risco diferentes, carteira unificada",
];
      ...
      <Card className="bg-card/95 border border-border/60 rounded-2xl shadow-2xl max-w-lg w-full">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Construa uma vida financeira a dois sem conflito
          </p>
