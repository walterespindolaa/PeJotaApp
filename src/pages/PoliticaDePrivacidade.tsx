...
const PoliticaDePrivacidade = () => {
  return (
    <>
    <SEO
      title="Política de Privacidade | PeJota"
      description="Saiba como o PeJota coleta, usa e protege seus dados pessoais e financeiros. Transparência total sobre privacidade e LGPD."
      path="/politica-de-privacidade"
    />
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-4xl px-6 py-10 space-y-8">
        <header className="space-y-3">
          <h1 className="text-3xl font-heading font-bold">POLÍTICA DE PRIVACIDADE – PEJOTA</h1>
