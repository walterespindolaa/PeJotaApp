...
import { Receipt, Sparkles, Clock, ArrowRight, CheckCircle2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent } from "@/components/ui/card";

const BENEFITS = [
  "Como o IR realmente funciona: tabela progressiva e deduções",
  "Investimentos e IR: renda fixa, ações, FIIs e come-cotas",
  "PGBL vs VGBL: quando cada um faz sentido",
  "PJ vs CLT: o cálculo real que ninguém faz",
  "O calendário tributário do investidor",
];
      ...
      <Card className="bg-card/95 border border-border/60 rounded-2xl shadow-2xl max-w-lg w-full">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Pague menos imposto usando o que a lei já permite
          </p>
