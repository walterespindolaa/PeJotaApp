...
import { Building2, Sparkles, Clock, ArrowRight, CheckCircle2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent } from "@/components/ui/card";

const BENEFITS = [
  "O que são FIIs e os 3 tipos: tijolo, papel e FOFs",
  "Como analisar um FII: DY, P/VP, vacância e gestão",
  "FIIs de tijolo vs papel — quando usar cada um",
  "Montando sua carteira de renda passiva",
  "O plano de substituição de renda: do zero até viver de FIIs",
];

const RendaPassivaFIIs = () => {
      ...
      <Card className="bg-card/95 border border-border/60 rounded-2xl shadow-2xl max-w-lg w-full">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Construa sua liberdade financeira com Fundos Imobiliários
          </p>
...
export default RendaPassivaFIIs;
