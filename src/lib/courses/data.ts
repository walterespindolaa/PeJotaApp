...
export const CURSO_ORGANIZACAO: Course = {
  ...
  subtitle: "Organização PeJota",
  description:
    "Como usar o PeJota no dia a dia. Rituais diários, semanais e mensais que transformam o app em hábito e te dão clareza sobre pra onde vai o seu dinheiro. Em 30 dias seguindo o curso, você sai com controle real do seu mês.",
  ...
  modules: [
    ...
    },
    {
      ...
      iconName: "Settings",
      lessons: [
        { number: "1.1", title: "Cadastrando você e seu casal (ou sozinho) no PeJota", description: "Como configurar a família pra que o PeJota mostre dados relevantes pro seu contexto.", duration: 2, format: "mix", hasExercise: true, videoUrl: "https://iframe.mediadelivery.net/embed/662798/3c6e7726-5bb3-4461-aa16-73c3ac516c06" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { number: "2.3", title: "PeJota Chat: quando pedir ajuda ao invés de pensar sozinho", description: "O chat é consultor dentro do app. Use pra dúvida rápida no meio do dia.", duration: 2, format: "mix", hasExercise: false, videoUrl: "https://iframe.mediadelivery.net/embed/662798/40f9e806-ff44-4289-a903-2528c2e335f1" },
      ],
    },
    {
      number: 3,
    ...
    },
    {
      number: 5,
      title: "Casos reais",
      subtitle: "Três situações que acontecem com todo mundo. Como o PeJota ajuda.",
      ...
      lessons: [
        ...
        { number: "5.3", title: "Meu casal discorda sobre um gasto", description: "O PeJota não resolve, mas vira árbitro neutro. Ritual mensal de 30 minutos que muda a dinâmica.", duration: 3, format: "camera", hasExercise: false, videoUrl: "https://iframe.mediadelivery.net/embed/662798/5e738a11-4df0-4ec8-a4f9-a091a2910aab" },
      ],
    },
    {
      number: 6,
      title: "PeJota Negócios (para PJ)",
      subtitle: "Opcional. Pra quem tem PJ e quer separar de verdade.",
      iconName: "Briefcase",
      lessons: [
        { number: "6.1", title: "Quando separar PJ e PF no PeJota", description: "Se é MEI simples, você pode não precisar. Se tem movimentação real, separar é obrigatório.", duration: 2, format: "mix", hasExercise: false, videoUrl: "https://iframe.mediadelivery.net/embed/662798/6d6911d5-a766-47b6-9433-3cbe6bc90b73" },
...
export const CURSO_PLANEJAMENTO: Course = {
  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        { number: "1.1", title: "Lendo a Análise PeJota como um consultor lê", description: "A ordem certa de leitura: tendência, composição, alarmes. Uma pergunta no fim: o que destrava mais valor?", duration: 5, format: "mix", hasExercise: true, videoUrl: "" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { number: "2.4", title: "Registrando objetivos no PeJota sem furar depois", description: "As 3 armadilhas: dinheiro visível, valor-alvo redondo, objetivo sem data. Como configurar pra se defender de si mesmo.", duration: 5, format: "mix", hasExercise: true, videoUrl: "" },
      ],
    },
    {
      number: 3,
    ...
    },
    {
      ...
      lessons: [
        ...
        { number: "4.2", title: "Usando o simulador do PeJota sem se assustar", description: "Preencher com dados reais, ler os 3 cenários possíveis. O simulador não deprime — mostra onde você está.", duration: 5, format: "mix", hasExercise: true, videoUrl: "" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { number: "5.3", title: "Usando a Análise PeJota como agenda da revisão", description: "Os 6 blocos da Análise PeJota na ordem certa = roteiro pronto de revisão. Economia de tempo + qualidade.", duration: 4, format: "mix", hasExercise: false, videoUrl: "" },
      ],
    },
    {
      number: 6,
      title: "Quando procurar um consultor humano",
      subtitle: "Honestidade. PeJota resolve a maioria, mas não tudo.",
      iconName: "Users",
      lessons: [
        { number: "6.1", title: "Sinais de que você passou do que o PeJota resolve sozinho", description: "6 sinais concretos + o que não justifica consultor. Antes disso, 90 dias praticando os rituais.", duration: 5, format: "camera", hasExercise: false, videoUrl: "" },
      ],
    },
  ],
};
