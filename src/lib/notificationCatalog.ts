/**
 * Atlas Notification Engine — Central Catalog
 *
...
const habito: NotificationDefinition[] = [
  ...
  },
  {
    ...
    name: "Início do mês",
    block: "habito",
    description: "Entre dia 1-3 do mês: incentiva atualização do Atlas.",
    priority: "medium",
...
const reativacao: NotificationDefinition[] = [
  {
    ...
    name: "Inativo 3 dias",
    block: "reativacao",
    description: "Usuário não acessou o Atlas nos últimos 3 dias.",
    priority: "low",
  ...
  },
  {
    ...
    name: "Inativo 7 dias",
    block: "reativacao",
    description: "Usuário não acessou o Atlas nos últimos 7 dias.",
    priority: "medium",
  ...
  },
  {
    ...
    block: "reativacao",
    description: "Usuário não acessou o Atlas nos últimos 14 dias.",
    priority: "medium",
  ...
  },
  {
    ...
    block: "reativacao",
    description: "Usuário não acessou o Atlas nos últimos 30 dias.",
    priority: "low",
...
const insights: NotificationDefinition[] = [
  {
    ...
    name: "Atlas Score subiu",
    block: "insight",
    description: "Score do Atlas subiu em relação ao mês anterior.",
    priority: "low",
    title: "Score subiu! 🏆",
