...
import { Download, ArrowUpDown, Filter, Users, Info } from "lucide-react";
...
export default function TabLancamentos() {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `fluxo-caixa-${mesAno}.csv`;
    a.click();
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/30 rounded-lg px-3 py-2 border border-border/40">
        ...
        <span>Os lançamentos são criados na área <strong>Planejamento e Controle</strong>. Esta aba é para análise e visualização.</span>
      </div>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1.5">
                          <Avatar className="h-5 w-5">
                            {getAvatar(r.responsavel) ? <AvatarImage src={getAvatar(r.responsavel)} /> : null}
