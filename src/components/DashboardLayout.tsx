...
const DashboardLayout = () => {
  ...
  const groups: SidebarNavGroup[] = [
    ...
    { title: "Vendas", dot: "bg-accent", items: [
      { to: "/dashboard/funil", icon: Filter, label: "Funil de vendas" },
      { to: "/dashboard/clientes", icon: Users, label: "Clientes (CRM)" },
      { to: "/dashboard/propostas", icon: FileText, label: "Propostas" },
    ]},
    { title: "Financeiro", dot: "bg-success", items: [
      ...
      { to: "/dashboard/notas-fiscais", icon: FileText, label: "Notas fiscais" },
    ...
    { title: "Estoque", dot: "bg-amber-500", items: [
      { to: "/dashboard/estoque", icon: Boxes, label: "Produtos e insumos" },
      { to: "/dashboard/estoque", icon: ClipboardList, label: "Ficha técnica" },
      { to: "/dashboard/estoque", icon: Repeat, label: "Movimentações" },
      { to: "/dashboard/estoque", icon: Tag, label: "Precificação" },
    ]},
    ...
    { title: "Configuração", dot: "bg-warning", items: [
      ...
      { to: "/dashboard/configuracoes", icon: Palette, label: "Aparência / Temas" },
