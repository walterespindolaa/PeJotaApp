...
const TRIGGERS: TriggerDef[] = [
  {
    ...
    blocks: [
      ...
      "O módulo **Evolução Patrimonial e Planejamento Financeiro** do Atlas Pro mostra exatamente isso:\ncomo seu patrimônio está crescendo e o caminho até sua independência financeira.",
    ],
    buttonLabel: "Desbloquear Atlas Pro",
  ...
  },
  {
    ...
    blocks: [
      ...
      "O **Planejamento Financeiro completo do Atlas Pro** conecta suas receitas, despesas e patrimônio para mostrar:",
      "• quanto você pode investir\n• quanto precisa acumular\n• quando poderá atingir seus objetivos",
    ],
    buttonLabel: "Conhecer Atlas Pro",
  ...
  },
  {
    ...
    blocks: [
      ...
      "O módulo **Carteira de Investimentos do Atlas Pro** permite:",
