...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirme seu e-mail — Atlas',
  invite: 'Você foi convidado — Atlas',
  magiclink: 'Seu link de acesso — Atlas',
  recovery: 'Redefinir sua senha — Atlas',
  email_change: 'Confirme a alteração de e-mail — Atlas',
  reauthentication: 'Seu código de verificação — Atlas',
}
...
const ROOT_DOMAIN = "app.useatlasapp.com"
...
const SAMPLE_PROJECT_URL = "https://app.useatlasapp.com"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  if (!emailRes.ok) {
    ...
    console.error('Resend email error', { error: errText, run_id })
  ...
  console.log('Email sent successfully', { id: result.id, run_id })
