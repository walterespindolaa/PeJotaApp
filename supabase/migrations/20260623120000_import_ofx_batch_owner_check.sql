-- Atlas — import_ofx_batch: corrige IDOR
-- Adiciona checagem de posse de p_account_id (a conta precisa pertencer ao auth.uid()).
-- Mantém o restante da função idêntico.
...
BEGIN
  ...
  -- IDOR guard: a conta informada precisa pertencer ao usuário autenticado.
